...
function SettingsWorkspace({ categories, accountPanels, forcePasswordChange = false }: { categories: DropdownCategory[]; accountPanels: React.ReactNode; forcePasswordChange?: boolean }) {
    ...
    return <div className="settings-workspace">
        <aside className="settings-subnav">
            ...
            {!forcePasswordChange && <button className={section === 'dropdowns' ? 'active' : ''} onClick={() => setSection('dropdowns')}><Database/> Dropdown data</button>}

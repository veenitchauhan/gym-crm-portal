    ...
    return <><Head title={`${member.name} · Member details`}/><AdminLayout activeSection="Members" user={currentUser}>
        <div className="member-profile-page">
            ...
            <section className="member-detail-grid">
                ...
                <article className="card member-stat-card"><CalendarCheck/><span>This month</span><strong>{member.monthVisits}</strong><small>gym visits</small></article>
                <article className="card member-stat-card"><Clock3/><span>All time</span><strong>{member.attendanceCount}</strong><small>attendance records</small></article>
            </section>
